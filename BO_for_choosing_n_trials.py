...
param = parameter.Parameter(x_type="ordinal", x_range=[0, 196], interval=1)
print(bayopt.run_single_obj_experiment(run_bayes_opt_benchmark_fns, parameter_list=[param], sampling_method="LHS", n_init=4, n_trials=8))