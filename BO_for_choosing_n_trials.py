...
def run_bayes_opt_benchmark_fns(n_trials):
    func = bf.Rosenbrock(n_dimensions=4)
    total_samples = 50
    iterations = 3
...
param = parameter.Parameter(x_type="ordinal", x_range=[0, 46], interval=1)
print(bayopt.run_single_obj_experiment(run_bayes_opt_benchmark_fns, parameter_list=[param], sampling_method="LHS", n_init=4, n_trials=8, plotting_flag=True, save_fig_flag=True))
