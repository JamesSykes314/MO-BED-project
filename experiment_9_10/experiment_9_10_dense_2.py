# Same as experiment_9_10_dense but we use a less optimistic reference point
# Note: the optimistic reference point used was obtained by 3 compounds of 45 from GPT smiles)
import os
import sys
import time
