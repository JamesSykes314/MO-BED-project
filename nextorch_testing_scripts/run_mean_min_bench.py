...
run_bayes_opt_benchmark_fns = sob.choose_mean_min_bench_args(desired_func, args.n_dims, args.total_samples)
param = parameter.Parameter(x_type="ordinal", x_range=[0, args.total_samples - 4], interval=1)
print(bayopt.run_single_obj_experiment(run_bayes_opt_benchmark_fns, parameter_list=[param], sampling_method="LHS",
                                       n_init=15, n_trials=10, plotting_flag=False, save_final_fig=True))
